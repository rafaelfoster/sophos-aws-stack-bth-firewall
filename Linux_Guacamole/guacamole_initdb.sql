...
-- Create user "{USERNAME}" with password "{DEFAULTPASSWORD}"
...
SELECT
    entity_id,
    @salt,
    UNHEX(SHA2(CONCAT('{DEFAULTPASSWORD}', HEX(@salt)), 256)),
    CURRENT_TIMESTAMP
...
INSERT INTO `guacamole_connection` VALUES (1,'Kali Linux (SSH)',1,'ssh',NULL,NULL,NULL,NULL,2,NULL,0),(2,'Windows 2012 Server (RDP)',2,'rdp',NULL,NULL,NULL,NULL,2,NULL,0),(3,'Linux Web Server (SSH)',2,'ssh',NULL,NULL,NULL,NULL,2,NULL,0),(4,'Kali Linux GUI (VNC)',1,'vnc',NULL,NULL,NULL,NULL,2,NULL,0);

INSERT INTO `guacamole_connection_parameter` VALUES (1,'hostname','10.1.10.100'),(1,'password','{DEFAULTPASSWORD}'),(1,'port','22'),(1,'username','adminkali'),(2,'hostname','10.1.20.50'),(2,'ignore-cert','true'),(2,'password','{DEFAULTPASSWORD}'),(2,'port','3389'),(2,'username','{USERNAME}'),(3,'hostname','10.1.20.60'),(3,'password','{DEFAULTPASSWORD}'),(3,'port','22'),(3,'username','{USERNAME}'), (4,'password','{DEFAULTPASSWORD}'),(4,'hostname','10.1.10.100'),(4,'port','5901');
